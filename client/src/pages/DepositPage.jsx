...
const DepositPage = () => {
  ...
  return (
    ...
    <div className="absolute top-28 left-6 sm:left-10 z-10 bg-black/50 px-3 py-2 rounded-lg">
      ...
      <div className="max-w-lg mx-auto mt-20 p-6 bg-black/40 backdrop-blur-3xl border border-yellow-500/40 rounded-3xl shadow-[0px_0px_50px_rgba(253,199,0,0.5)] text-white text-center">
